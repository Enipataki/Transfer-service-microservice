...
exports.limitServiceInstance = exports.LimitServiceMock = void 0;
class LimitServiceMock {
    constructor() {
    ...
    validateTransferLimits(validationData) {
    ...
    updateLimitsAfterTransfer(updateData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.transactionHistory.set(updateData.transactionId, {
                ...
                previousLimits: Object.assign({}, userLimit),
                newLimits: Object.assign({}, userLimit),
                timestamp: new Date()
            });
            return {
                success: true,
    ...
    getUserLimits(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, userLimit), { nextReset: this.getNextLimitReset(), utilization: {
    ...
    resetUserLimits(userId, resetType) {
        return __awaiter(this, void 0, void 0, function* () {
            const userLimit = this.userLimits.get(userId);
            if (!userLimit) {
                throw new Error('USER_LIMITS_NOT_FOUND');
    ...
    checkAMLCompliance(complianceData) {
        return __awaiter(this, void 0, void 0, function* () {
            // Simulate AML checks
    ...
    getLimitUsageReport(userId, period) {
        return __awaiter(this, void 0, void 0, function* () {
            const userLimit = yield this.getUserLimits(userId);
            const reports = {
                day: {
                    period: 'daily',
...
exports.LimitServiceMock = LimitServiceMock;
exports.limitServiceInstance = new LimitServiceMock();
