...
export class TransferService {
    ...
    // Compliance check
    async performComplianceChecks(input) {
    ...
    async validateTransfer(input, transactionType) {
     ...
     */
    async createdBulkTransfer(input, idempotencyKey) {
        if (idempotencyKey) {
     ...
     */
    async createRecurringTransfer(input) {
        return await db.transaction(async (client) => {
