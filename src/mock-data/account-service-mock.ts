export class AccountServiceMock {
  ...
  async debitAccount(accountId: string, amount: number, reference: string) {
  ...
  async creditAccount(accountId: string, amount: number, reference: string) {
    const account = await this.getAccount(accountId);
  ...
  async validateAccounts(senderAccountId: string, recipientAccountId: string) {
